...
// NewsPublic SDK ratelimit feature
...
class NewsPublicRatelimitFeature extends NewsPublicBaseFeature
{
    ...
    private function _acquire(NewsPublicContext $ctx): void
    {
    ...
    private function _track(NewsPublicContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
