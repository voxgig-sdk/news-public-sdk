...
// NewsPublic SDK timeout feature
...
class NewsPublicTimeoutFeature extends NewsPublicBaseFeature
{
    ...
    private function _with_timeout(NewsPublicContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(NewsPublicContext $_ctx, float $ms): void
    {
        $client = $this->client;
