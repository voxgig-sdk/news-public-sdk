...
class NewsPublicProxyFeature extends NewsPublicBaseFeature
{
    ...
    public function init(NewsPublicContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (NewsPublicContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
