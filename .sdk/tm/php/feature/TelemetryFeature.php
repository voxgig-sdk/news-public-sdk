...
// NewsPublic SDK telemetry feature
...
class NewsPublicTelemetryFeature extends NewsPublicBaseFeature
{
    ...
    private function _close(NewsPublicContext $ctx, bool $ok): void
    {
