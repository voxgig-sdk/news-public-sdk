...
class NewsPublicCacheFeature extends NewsPublicBaseFeature
{
    ...
    private function _through(NewsPublicContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
