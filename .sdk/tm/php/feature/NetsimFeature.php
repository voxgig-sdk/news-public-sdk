...
class NewsPublicNetsimFeature extends NewsPublicBaseFeature
{
    ...
    private function _simulate(NewsPublicContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(NewsPublicContext $ctx, array $applied): void
    {
        $client = $this->client;
