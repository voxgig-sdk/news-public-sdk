...
class NewsPublicRbacFeature extends NewsPublicBaseFeature
{
    ...
    private function _required(NewsPublicContext $ctx): ?string
    {
    ...
    private function _reject(NewsPublicContext $ctx, string $required): void
    {
    ...
    private function _track(NewsPublicContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
