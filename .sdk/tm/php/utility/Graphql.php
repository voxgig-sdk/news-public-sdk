...
// NewsPublic SDK utility: graphql
//
...
class NewsPublicGraphql
{
    ...
    // equivalent.
    public static function body(NewsPublicContext $ctx): mixed
    {
    ...
    public static function errors(NewsPublicContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
