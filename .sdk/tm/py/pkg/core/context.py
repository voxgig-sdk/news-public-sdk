...
from projectname_sdk.core.control import NewsPublicControl
...
class NewsPublicContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, NewsPublicSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, NewsPublicResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, NewsPublicResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return NewsPublicError(code, msg, self)
