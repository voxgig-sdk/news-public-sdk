# NewsPublic SDK primary utility test
...
from projectname_sdk import NewsPublicSDK
from projectname_sdk.core.spec import NewsPublicSpec
from projectname_sdk.core.result import NewsPublicResult
from projectname_sdk.core.response import NewsPublicResponse
from projectname_sdk.core.operation import NewsPublicOperation
from projectname_sdk.core.error import NewsPublicError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import NewsPublicBaseFeature
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return NewsPublicError(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = NewsPublicSDK.test(None, None)
        ...
        class TestInitFeature(NewsPublicBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(NewsPublicBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = NewsPublicSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = NewsPublicSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = NewsPublicSDK.test(None, setup_opts)
