...
// NewsPublic SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (NewsPublicSDK::test)
...
{
    private const SDK_CLASS = 'NewsPublicSDK';
    ...
    private const SDK_BASE = 'newspublic_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../newspublic_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
