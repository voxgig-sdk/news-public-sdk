...
class NewsPublicTestRunner
{
    ...
    {
        $live = self::getenv('NEWS_PUBLIC_TEST_LIVE');
        $override = self::getenv('NEWS_PUBLIC_TEST_OVERRIDE');
        ...
        $explain = self::getenv('NEWS_PUBLIC_TEST_EXPLAIN');
...
class_alias('NewsPublicTestRunner', 'Runner');
class_alias('NewsPublicHelpers', 'Helpers');
