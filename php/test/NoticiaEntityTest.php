...
class NoticiaEntityTest extends TestCase
{
    ...
    public function test_stream(): void
    {
        ...
        $base = NewsPublicSDK::test($seed, null);
        $seen = iterator_to_array($base->Noticia(null)->stream("list", null, null), false);
        ...
        if (isset($cfg["feature"]) && is_array($cfg["feature"]) && isset($cfg["feature"]["streaming"])) {
            ...
            $got = [];
            foreach ($sdk->Noticia(null)->stream("list", null, null) as $item) {
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set NEWS_PUBLIC_TEST_NOTICIA_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function noticia_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("NEWS_PUBLIC_TEST_NOTICIA_ENTID");
