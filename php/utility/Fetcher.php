...
// NewsPublic SDK utility: fetcher

class NewsPublicFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; NewsPublicSDK/1.0)';
    ...
    public static function call(NewsPublicContext $ctx, string $fullurl, array $fetchdef): array
    {
