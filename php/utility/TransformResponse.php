...
// NewsPublic SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class NewsPublicTransformResponse
{
    public static function call(NewsPublicContext $ctx): mixed
    {
        ...
        $transform = NewsPublicHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
