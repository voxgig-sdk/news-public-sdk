...
// NewsPublic SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class NewsPublicTestFeature extends NewsPublicBaseFeature
{
    ...
    public function init(NewsPublicContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (NewsPublicContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = NewsPublicParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (NewsPublicContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(NewsPublicContext $ctx, $op, $args): array
    {
