...
// NewsPublic SDK clienttrack feature
...
class NewsPublicClienttrackFeature extends NewsPublicBaseFeature
{
    ...
    public function PostConstruct(NewsPublicContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'NewsPublic-SDK';
