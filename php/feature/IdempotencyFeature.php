...
// NewsPublic SDK idempotency feature
...
class NewsPublicIdempotencyFeature extends NewsPublicBaseFeature
{
    ...
    private function _mutating(NewsPublicContext $ctx): bool
    {
