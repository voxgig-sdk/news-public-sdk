...
// NewsPublic SDK streaming feature
...
class NewsPublicStreamingFeature extends NewsPublicBaseFeature
{
    ...
    private function _iterate(NewsPublicResult $result): \Generator
    {
    ...
    private function _streamable(NewsPublicContext $ctx): bool
    {
