...
func (sdk *NewsPublicSDK) OptionsMap() map[string]any {
...
func (sdk *NewsPublicSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *NewsPublicSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *NewsPublicSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *NewsPublicSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *NewsPublicSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *NewsPublicSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("NewsPublicSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *NewsPublicSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *NewsPublicSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("NewsPublicSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
