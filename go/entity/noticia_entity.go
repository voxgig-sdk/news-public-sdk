...
func NewNoticiaEntity(client *core.NewsPublicSDK, entopts map[string]any) *NoticiaEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *NoticiaEntity) GetName() string { return e.name }
...
func (e *NoticiaEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *NoticiaEntity) Deleted() bool {
	return e.deleted
}


func (e *NoticiaEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewNoticiaEntity(e.client, opts)
}

func (e *NoticiaEntity) Data(args ...any) any {
...
func (e *NoticiaEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Noticia; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *NoticiaEntity) DataTyped(data ...Noticia) Noticia {
	if len(data) > 0 {
		return typedFrom[Noticia](e.Data(asMap(data[0])))
	}
	return typedFrom[Noticia](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Noticia (all fields
// optional at the wire level).
func (e *NoticiaEntity) MatchTyped(match ...Noticia) Noticia {
	if len(match) > 0 {
		return typedFrom[Noticia](e.Match(asMap(match[0])))
	}
	return typedFrom[Noticia](e.Match())
}
...
func (e *NoticiaEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *NoticiaEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *NoticiaEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// NoticiaListMatch and returns []Noticia. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *NoticiaEntity) ListTyped(reqmatch NoticiaListMatch, ctrl map[string]any) ([]Noticia, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Noticia](res), nil
}



func (e *NoticiaEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *NoticiaEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *NoticiaEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *NoticiaEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
