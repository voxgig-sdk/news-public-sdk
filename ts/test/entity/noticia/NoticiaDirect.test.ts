...
describe('NoticiaDirect', async () => {
  ...
  test('direct-list-noticia', async (t: any) => {
    const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }])
    if (maybeSkipControl(t, 'direct', 'direct-list-noticia', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['NEWS_PUBLIC_TEST_NOTICIA_ENTID']
