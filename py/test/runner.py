...
class NewsPublicTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = NewsPublicTestRunner.getenv("NEWSPUBLIC_TEST_LIVE")
        override = NewsPublicTestRunner.getenv("NEWSPUBLIC_TEST_OVERRIDE")
        ...
        explain = NewsPublicTestRunner.getenv("NEWSPUBLIC_TEST_EXPLAIN")
        if explain is not None and explain != "":
            m["NEWSPUBLIC_TEST_EXPLAIN"] = explain
