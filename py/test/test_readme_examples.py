# NewsPublic SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions NewsPublicSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both NewsPublicSDK(...) and NewsPublicSDK.test(...) become
#      NewsPublicSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "newspublic_sdk"
_SDK_CLASS = "NewsPublicSDK"
