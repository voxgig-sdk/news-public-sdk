...
from newspublic_sdk.utility import register

# Load features
from newspublic_sdk.feature.base_feature import NewsPublicBaseFeature
from newspublic_sdk.features import _has_feature, _make_feature
...
class NewsPublicSDK:
    ...
    def get_utility(self):
        return NewsPublicUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("NewsPublicSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Noticia(self, data=None) -> "NoticiaEntity":
        ...
        from newspublic_sdk.entity.noticia_entity import NoticiaEntity
