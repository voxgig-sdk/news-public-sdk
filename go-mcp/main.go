// Command NewsPublic-mcp is an MCP server exposing the NewsPublic
// SDK as MCP tools.
//
// Two tools are registered:
//
//	NewsPublic_list  — list records of an entity
//	NewsPublic_load  — load a single record of an entity
//
