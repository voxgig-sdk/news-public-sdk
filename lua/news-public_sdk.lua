...
local NewsPublicSDK = {}
NewsPublicSDK.__index = NewsPublicSDK
...
NewsPublicSDK._make_feature = _make_feature


function NewsPublicSDK.new(options)
  local self = setmetatable({}, NewsPublicSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function NewsPublicSDK:options_map()
...
function NewsPublicSDK:get_utility()
  return Utility.copy(self._utility)
end


function NewsPublicSDK:get_root_ctx()
  return self._rootctx
end


function NewsPublicSDK:prepare(fetchargs)
...
function NewsPublicSDK:direct(fetchargs)
...
-- by passing it.
function NewsPublicSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function NewsPublicSDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "NewsPublicSDK: graphql: " .. msg
    res.graphql = errors
  end
...
function NewsPublicSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = NewsPublicSDK.new(sdkopts)
  sdk.mode = "test"
