...
describe("NoticiaDirect", function()
  it("should direct-list-noticia", function()
    local setup = noticia_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-noticia", setup.live and "live" or "unit")
