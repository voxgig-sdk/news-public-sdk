...
function runner.env_override(m)
  local live = runner.getenv("NEWS_PUBLIC_TEST_LIVE")
  local override = runner.getenv("NEWS_PUBLIC_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("NEWS_PUBLIC_TEST_EXPLAIN")
