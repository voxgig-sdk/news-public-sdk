...
func registerSDKWords(r *eng.Registry, client *sdk.NewsPublicSDK) {
...
func runOp(client *sdk.NewsPublicSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
