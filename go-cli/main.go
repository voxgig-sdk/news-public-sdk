// Command NewsPublic-cli is a CLI + REPL for the NewsPublic SDK,
...
const prompt = "news-public"

// entitiesHelp is the space-separated entity list shown by /help.
const entitiesHelp = "noticia"
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      NEWS_PUBLIC_APIKEY (api key), NEWS_PUBLIC_BASE (base url override)")
...
func run(args []string, in io.Reader, out, errOut io.Writer) int {
	...
	// Configure from the environment: NEWS_PUBLIC_APIKEY carries the API key and
	// NEWS_PUBLIC_BASE optionally overrides the API base URL (e.g. production).
	// Both injectable by a secrets vault. Unset -> nil config defaults.
	var opts map[string]any
	if apikey := os.Getenv("NEWS_PUBLIC_APIKEY"); apikey != "" {
		opts = map[string]any{"apikey": apikey}
	}
	if base := os.Getenv("NEWS_PUBLIC_BASE"); base != "" {
		if opts == nil {
			opts = map[string]any{}
		}
		opts["base"] = base
	}
	client := sdk.NewNewsPublicSDK(opts)
